            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <h2>Sistem Informasi Arsip Pengadilan Duri Riau </h2>
                        <h4>Jalan Jawa Gg Kelapa No. 28, Gajah Sakti, Duri <br> Kota Duri, Kabupaten Bengkalis, Riau, 28784</h4>
                        <hr>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM arsip WHERE substr(tgl_masuk,1,4)='$ambilthn'";
                            ...
                            <tfoot>
                              <tr>
                                <td colspan="8" class="text-right">
                                        Duri,  &nbsp <?= date("d-m-Y") ?>
                                        <br><br><br><br>
                                        <u>Teknik Informatika, S.i.kom<strong></u><br>
                                        NIM.1937006
									             </td>
								</tr>
							</tfoot>
